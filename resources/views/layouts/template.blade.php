        ...
        <aside class="w-64 bg-white shadow-lg">
            ...
            <nav class="mt-10">
                ...
                <a href="{{ route('customer.show') }}"
                    class="flex items-center px-6 py-2 gap-3 text-gray-600 hover:bg-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                        <path
                ...
                <a href="#" class="flex items-center px-6 py-2 gap-3 text-gray-600 hover:bg-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6">
                        <path
    ...
    $(document).ready(function() {
        ...
        tabButtons.forEach(button => {
            button.addEventListener('click', () => {
                ...
                button.classList.add('border-blue-500', 'text-blue-600', 'border-b-2',
                    'border-blue-600');
        ...
        tabButtons["{{ session()->get('tab-position') ?? 0 }}"].click();
